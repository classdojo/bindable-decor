...
(function() {
  ...
  BindableDecor = (function() {
    ...
    */
    ...
    BindableDecor.prototype.use = function(options) {
      var decorator;
      ...
      decorator = options.clazz || options.factory || options.decorator;
      if (!decorator.options) {
        decorator.options = decorator.getOptions;
      }
      return this._available.push({
