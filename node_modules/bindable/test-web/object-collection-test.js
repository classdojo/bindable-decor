(function() {
    ...
    define("bindable/test-web/object-collection-test.js", function(require, module, exports, __dirname, __filename) {
        var BindableCollection = require("bindable/lib/index.js").Collection, BindableObject = require("bindable/lib/index.js").Object, expect = require("expect.js/expect.js");
        describe("bindable object collection", function() {
            var col1 = new BindableCollection([ {
                ...
                lname: "Liam"
            } ], "lname"), col2 = new BindableCollection([ {
                name: "craig"
            }, {
                name: "josh"
            }, {
                name: "jake"
            } ], "name"), col3 = new BindableCollection, bindable = new BindableObject({
                source: col1
            });
    ...
    var entries = [ "bindable/test-web/object-collection-test.js" ];
