(function() {
    ...
    define("bindable/test-web/collection-test.js", function(require, module, exports, __dirname, __filename) {
        var Collection = require("bindable/lib/index.js").Collection, expect = require("expect.js/expect.js"), _ = require("underscore/underscore.js"), sift = require("sift/sift.js");
        describe("bindable collection", function() {
            var col1 = new Collection([ {
                ...
                lname: "Liam"
            } ], "lname"), col2 = new Collection([ {
                name: "Chris"
            }, {
                name: "Frank"
            } ], "name"), col3 = new Collection("lname"), col4 = new Collection("lname"), col5 = new Collection("lname"), bindings = {};
            ...
            it("a binding with a filter can be created", function() {
                bindings.col12 = col1.bind().filter(sift({
                    lname: {
                        $ne: "Monica"
                    }
                }).test).transform(function(person) {
                    return {
                        name: person.lname
                    };
                }).to(col2).now();
            ...
            it("can bind to the collection empty state", function() {
                var isEmpty, col3 = new Collection([ {
                    _id: "craig"
                }, {
                    _id: "john"
                } ]);
            ...
            it("can transform objects", function() {
                col3.reset([]);
                col3._id("name");
                col3.transform().map(function(value) {
                    return {
                        name: value
                    };
                });
    ...
    var entries = [ "bindable/test-web/collection-test.js" ];
