(function() {
    ...
    define("bindable/test-web/object-test.js", function(require, module, exports, __dirname, __filename) {
        var BindableObject = require("bindable/lib/index.js").Object, expect = require("expect.js/expect.js");
        describe("bindable object", function() {
            ...
            it("can listen for multiple change events", function() {
                ...
                bindable.set("person.name", new BindableObject({
                    first: "josh"
                }));
            ...
            it("can perform multiple mappings", function() {
                ...
                }).to("nameLowerCase").map(function(name) {
                    return String(name).toUpperCase();
                }).to("nameUpperCase").now();
            ...
            it("can bind to a computed property", function() {
                ...
                bindable.bind("firstName, lastName").map(function(firstName, lastName) {
            ...
            it("can bind a computed property both ways", function() {
                ...
                bindable.bind("firstName, lastName").map({
            ...
            if (false) it("can bind an undefined property and still get triggered", function() {
                var bindable = new BindableObject({
                    name: "Craig"
                }), a, b = 0;
    ...
    var entries = [ "bindable/test-web/object-test.js" ];
